...
<!-- Banner -->
![Banner](https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=0,2,4,6,8&height=220&text=📋%20FlowCard&fontColor=1d1d1f&fontSize=52&fontAlignY=40&desc=让复杂流程变得清晰易读&descColor=86868b&descSize=20&descAlignY=65&section=header)
...
我在行政部门从事门禁管理工作，长期被流程文档低效传达的问题困扰。这个项目是我第一次尝试用 AI 协作编程解决真实工作痛点的完整实践记录。
...
<!-- 底部波浪 -->
![Footer](https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=0,2,4,6,8&height=100&section=footer)
